...
func (l *DeleteOrderLogic) DeleteOrder(req *types.DeleteOrderReq) (resp *types.BaseMsgResp, err error) {

	if !l.svcCtx.Config.WolfLampRpc.Enabled {
		return nil, errorx.NewCodeUnavailableError(i18n.ServiceUnavailable)
	}
	data, err := l.svcCtx.WolfLampRpc.DeleteOrder(l.ctx,
		&wolflamp.DeleteOrderReq{
			Id: req.Id,
		})
	if err != nil {
		return nil, err
